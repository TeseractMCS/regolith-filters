...
const teseractPlugin = JSON5.parse(readFileSync(path.join(resourcesPath, "teseract.script.json")).toString());
...
if (scriptModule) {
    console.warn(`Scripting module is already present in the manifest, and won't be overriden. WARNING: This may cause entrypoint file to differ from entry point auto-generated by the vanilla loom.`);
}
else {
